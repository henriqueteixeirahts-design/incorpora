      ...
      <div style={{ marginTop: "1.5rem" }}>
        <ExchangeContractsManager
          ...
          contracts={contracts.map((c) => ({
            ...
            retentionPct: c.retentionPct === null ? null : Number(c.retentionPct),
            retentionReleaseTrigger: c.retentionReleaseTrigger,
            retentionReleaseDate: c.retentionReleaseDate,
